...
BOT3::BOT3(sf::Texture* texture, sf::Vector2u imageCount, float switchTime, float speed, sf::Vector2f pos) :
...
void BOT3::Update(float deltaTime, float switchTime, int speed, sf::Vector2f curpos, sf::Vector2f despos)
{
...
void BOT3::Draw(sf::RenderWindow& window)
{
	window.draw(body);
}